// Importa el hook useContext de React y el contexto del usuario
 ...
 * AccesoRestringido
 *
 * Componente para mostrar un mensaje de acceso restringido a usuarios no autenticados.
 * Ofrece un botón para iniciar sesión con Google.
 *
 * Props:
 * - mensaje: título principal del mensaje (opcional, por defecto "Acceso restringido")
 * - descripcion: texto descriptivo debajo del título (opcional, por defecto con instrucción)
 */
